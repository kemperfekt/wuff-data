...
try:
    ...
    client.collections.create(
        ...
        vectorizer_config=wvcc.Configure.Vectorizer.text2vec_openai(
            model="ada-002",
            properties=["thema", "beschreibung", "hundeperspektive"]
        ),
        properties=[
    ...
    client.collections.create(
        ...
        vectorizer_config=wvcc.Configure.Vectorizer.text2vec_openai(
            model="ada-002",
            properties=["instinkt", "beschreibung", "hundesperspektive"]
        ),
        properties=[
    ...
    client.collections.create(
        ...
        vectorizer_config=wvcc.Configure.Vectorizer.text2vec_openai(
            model="ada-002",
            properties=["uebergruppe", "gruppe", "funktion", "merkmale", "erziehungsanforderung", "hundeperspektive"]
        ),
        properties=[
    ...
    client.collections.create(
        ...
        properties=[
            ...
            wvcc.Property(name="gruppen_code", data_type=wvcc.DataType.NUMBER),
            wvcc.Property(name="hatInstinktveranlagung", data_type=wvcc.DataType.OBJECT_ARRAY, 
    ...
    client.collections.create(
        ...
        vectorizer_config=wvcc.Configure.Vectorizer.text2vec_openai(
            model="ada-002",
            properties=["erziehungsaufgabe", "anleitung", "hintergrund", "hundeperspektive"]
        ),
        properties=[
            ...
            wvcc.Property(name="betrifftInstinkte", data_type=wvcc.DataType.OBJECT_ARRAY, 
    ...
    client.collections.create(
        ...
        vectorizer_config=wvcc.Configure.Vectorizer.text2vec_openai(
            ...
            properties=[
                "symptom_name", 
                "schnelldiagnose", 
                "hundeperspektive_jagdinstinkt", 
                "hundeperspektive_rudelinstinkt", 
                "hundeperspektive_territorialinstinkt",
                "hundeperspektive_sexualinstinkt",
                "erste_hilfe"
            ]
        ),
        properties=[
            ...
            wvcc.Property(name="beziehtSichAufInstinkte", data_type=wvcc.DataType.OBJECT_ARRAY, 
                          reference_to="Instinkte"),
            wvcc.Property(name="empfohleneErziehungsaufgaben", data_type=wvcc.DataType.OBJECT_ARRAY, 
